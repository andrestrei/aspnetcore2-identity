...
namespace DAL.Identity
{
    ...
    public class UserStore<TKey, TUser, TRole, TUserRole, TUserClaim, TUserLogin, TUserToken, TUOW> :
        ...
        where TUOW : IApplicationUnitOfWork<TKey, TUser, TRole>
    {
        ...
        public UserStore(TUOW uow, IdentityErrorDescriber describer)
        {
            _uow = uow;
        ...
        protected virtual IdentityUserRole<TKey> CreateUserRole(TUser user, TRole role)
        {
            return new IdentityUserRole<TKey>()
            {
                ...
                IdentityRoleId = role.IdentityRoleId
            };
        }
        ...
        {
            var userClaim = new IdentityUserClaim<TKey> { IdentityUserId = user.IdentityUserId };
        ...
        /// <returns></returns>
        protected virtual IdentityUserToken<TKey> CreateUserToken(TUser user, string loginProvider, string name, string value)
        {
        ...
        public virtual async Task<IdentityResult> CreateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _uow.IdentityUserRepository.Add(user);
        ...
        public virtual async Task<IdentityResult> UpdateAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _uow.IdentityUserRepository.Update(user);
            try
            {
        ...
        public virtual async Task<IdentityResult> DeleteAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _uow.IdentityUserRepository.Remove(user);
            try
            {
                await _uow.SaveChangesAsync(cancellationToken: cancellationToken);
            }
        ...
        public Task<TUser> FindByIdAsync(string userId, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return _uow.IdentityUserRepository.FindAsync(new object[] {id}, cancellationToken: cancellationToken);
        }
        ...
        public virtual Task<TUser> FindByNameAsync(string normalizedUserName, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return _uow.IdentityUserRepository.FindByNameAsync(normalizedUserName, cancellationToken);
        }
        ...
        public Task AddLoginAsync(TUser user, UserLoginInfo login, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _uow.IdentityUserLoginRepository.Add(CreateUserLogin(user: user, login: login));
        ...
        public virtual async Task RemoveLoginAsync(TUser user, string loginProvider, string providerKey, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            var entry = await FindUserLoginAsync(id: user.IdentityUserId, loginProvider: loginProvider, providerKey: providerKey, cancellationToken: cancellationToken);
            if (entry != null)
            {
                _uow.IdentityUserLoginRepository.Remove(entity: entry);
            }
        }
        ...
        {
            return _uow.IdentityUserRepository.FindAsync(userId, cancellationToken);
        }
        ...
        protected virtual Task<IdentityUserLogin<TKey>> FindUserLoginAsync(TKey id, string loginProvider, string providerKey, CancellationToken cancellationToken = default(CancellationToken))
        {
            return _uow.IdentityUserLoginRepository.FindUserLoginAsync(id, loginProvider, providerKey, cancellationToken);
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The user login if it exists.</returns>
        protected virtual Task<IdentityUserLogin<TKey>> FindUserLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken = default(CancellationToken))
        {
            return _uow.IdentityUserLoginRepository.FindUserLoginAsync(loginProvider: loginProvider,
                providerKey: providerKey, cancellationToken: cancellationToken);
        }
        ...
        public virtual async Task<IList<UserLoginInfo>> GetLoginsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await _uow.IdentityUserLoginRepository.GetLoginsAsync(user.IdentityUserId, cancellationToken);
        }
        ...
        public virtual async Task<TUser> FindByLoginAsync(string loginProvider, string providerKey, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (userLogin != null)
            {
                return await FindUserAsync(userId: userLogin.IdentityUserId, cancellationToken: cancellationToken);
            }
            return null;
        }
        ...
        public virtual async Task<IList<Claim>> GetClaimsAsync(TUser user, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await _uow.IdentityUserClaimRepository.GetClaimsAsync(user.IdentityUserId, cancellationToken);
        }
        ...
        public virtual async Task ReplaceClaimAsync(TUser user, Claim claim, Claim newClaim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await _uow.IdentityUserClaimRepository.ReplaceClaimAsync(user.IdentityUserId, claim, newClaim, cancellationToken);
        }
        ...
        public virtual async Task<IList<TUser>> GetUsersForClaimAsync(Claim claim, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            return await _uow.IdentityUserRepository.GetUsersForClaimAsync(claim, cancellationToken);
        }
        ...
        public virtual async Task RemoveClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            await _uow.IdentityUserClaimRepository
                .RemoveClaimsAsync(id: user.IdentityUserId, claims: claims, cancellationToken: cancellationToken);
        }
        ...
        public virtual Task AddClaimsAsync(TUser user, IEnumerable<Claim> claims, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                _uow.IdentityUserClaimRepository.Add(CreateUserClaim(user, claim));
            }
            return Task.FromResult(result: false);
        }
        ...
        public virtual Task<TUser> FindByEmailAsync(string normalizedEmail, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            return _uow.IdentityUserRepository.FindByEmailAsync(normalizedEmail, cancellationToken);
        }
        ...
        protected virtual Task<IdentityUserToken<TKey>> FindTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken)
            => _uow.IdentityUserTokenRepository.FindTokenAsync(id: user.IdentityUserId, loginProvider: loginProvider, name: name, cancellationToken: cancellationToken);
        ...
        //            => UserTokens.FindAsync(new object[] { user.Id
        ...
        public virtual async Task SetTokenAsync(TUser user, string loginProvider, string name, string value, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (token == null)
            {
                _uow.IdentityUserTokenRepository.Add(entity: CreateUserToken(user: user, loginProvider: loginProvider, name: name, value: value));
            }
            else
            {
                token.Value = value;
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>The <see cref="Task"/> that represents the asynchronous operation.</returns>
        public virtual async Task RemoveTokenAsync(TUser user, string loginProvider, string name, CancellationToken cancellationToken = default(CancellationToken))
        {
            cancellationToken.ThrowIfCancellationRequested();
            ThrowIfDisposed();
            ...
            if (entry != null)
            {
                _uow.IdentityUserTokenRepository.Remove(entity: entry);
            }
        }
        ...
        public virtual async Task AddToRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            _uow.IdentityUserRoleRepository.Add(entity: CreateUserRole(user: user, role: roleEntity));
        }
        ...
        public virtual async Task RemoveFromRoleAsync(TUser user, string normalizedRoleName, CancellationToken cancellationToken)
        {
            ...
            if (roleEntity != null)
            {
                ...
                if (userRole != null)
                {
                    _uow.IdentityUserRoleRepository.Remove(userRole);
                }
            }
        }
        ...
        public virtual async Task<IList<string>> GetRolesAsync(TUser user, CancellationToken cancellationToken)
        {
            ...
            return await _uow.IdentityUserRoleRepository.GetRolesAsync(userId: user.IdentityUserId, cancellationToken: cancellationToken);
        }
        ...
        public virtual async Task<bool> IsInRoleAsync(TUser user, string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            {
                throw new ArgumentException(message: "ValueCannotBeNullOrEmpty", paramName: nameof(roleName));
            }
            var role = await FindRoleAsync(normalizedRoleName: roleName, cancellationToken: cancellationToken);
            if (role != null)
            {
        ...
        public virtual async Task<IList<TUser>> GetUsersInRoleAsync(string roleName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (role != null)
            {
                return await _uow.IdentityUserRepository.GetUsersInRoleAsync(role.IdentityRoleId, cancellationToken);
            }
        ...
        protected virtual Task<IdentityUserRole<TKey>> FindUserRoleAsync(TKey userId, TKey roleId, CancellationToken cancellationToken = default(CancellationToken))
        {
            var res = _uow.IdentityUserRoleRepository.FindUserRoleAsync(userId: userId, roleId: roleId, cancellationToken: cancellationToken);
            return res;
        }
    }
}
